...
@include('partials.landingpages.update_post_landingpage')
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-8">
          ...
          <article class="blog-details">
            ...
            <div class="post-img">
              <img src="{{$newsUpdate->post_picture ? asset('storage/' . $newsUpdate->post_picture ) : asset('assets/img/blog/blog1.jpg') }}" alt="" class="img-fluid">
            </div>

            <h2 class="title">{{ $newsUpdate->post_title }}</h2>

            <div class="meta-top">
              <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> {{ $newsUpdate->user->name }}</li>
                <li class="d-flex align-items-center"><i class="bi bi-clock"></i><time datetime="2024-02-02">{{ date('jS M Y', strtotime($newsUpdate->created_at)) }}</time></li>
              </ul>
            </div><!-- End meta top -->

            <div class="content">
              {!! $newsUpdate->post_content  !!}
          ...
          <div class="post-author d-flex align-items-center">
            <img src="{{$newsUpdate->user->profile_pic ? asset('storage/' . $newsUpdate->user->profile_pic ) : asset('assets/img/blog/blog1.jpg') }}" class="rounded-circle flex-shrink-0" alt="">
            <div>
              <h4>{{ $newsUpdate->user->name }}</h4>
            ...
            <div class="mt-3">
              @if(@count($recentNewsUpdates) > 0)
                ...
                <div class="post-item mt-3">
                  ...
                  <div>
                    <h4><a href="{{ route('updates.show', ['id'=>$recentNewsUpdate->id]) }}">{{ $recentNewsUpdate->post_title }}</a></h4>
            ...
            <div class="mt-3">
              @if(@count($recentBlogPosts) > 0)
                ...
                <div class="post-item mt-3">
                  ...
                  <div>
                    <h4><a href="{{ route('blog.show', ['id'=>$recentBlogPost->id]) }}">{{ $recentBlogPost->post_title }}</a></h4>
            ...
            <div class="mt-3">
              @if(@count($recentProjects) > 0)
                ...
                <div class="post-item mt-3">
                  ...
                  <div>
                    <h4><a href="{{ route('projects.show', ['id'=>$recentProject->id]) }}">{{ $recentProject->post_title }}</a></h4>
