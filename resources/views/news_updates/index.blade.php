...
@include('partials.landingpages.updates_landingpage')
        ...
        <div class="col-xl-4 col-md-6">
          <div class="post-item position-relative h-100">
            ...
            <div class="post-content d-flex flex-column">
              ...
              <a href="{{ route('updates.show', ['id'=>$post->id]) }}" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
