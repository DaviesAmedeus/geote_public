...
<div class="row">
  <div class="col-md-12">
    <h4>News-Updates you've created.</h4>
  </div>
</div>
        ...
        <table class="table table-sm  table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{ route('updates.edit', ['id'=>$post->id]) }}" class="btn btn-sm btn-primary">Edit</a></td>
              <td>

                <form method="POST" action="{{ route('updates.delete', ['id'=>$post->id]) }}">
                  @csrf
                  @method('DELETE')
