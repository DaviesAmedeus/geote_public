...
use App\Filament\Staff\Resources\GISProgramResource\Pages;
use App\Filament\Staff\Resources\GISProgramResource\RelationManagers;
...
class GISProgramResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        $query = parent::getEloquentQuery()
            ->where('category_id', '=', 3); // Filter by category if needed
